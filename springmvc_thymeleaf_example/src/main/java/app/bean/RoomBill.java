...
public class RoomBill {
	   ...
	   public RoomBill(String roomBillId, String roomId, String roomName, String roomDateRent, String roomDateReturn, int roomPaymentStatus) {
	   ...
	   public String toString() {
	      return "RoomBill [roomBillId=" + this.roomBillId + ", roomId=" + this.roomId + ", roomName=" + this.roomName + ", roomDateRent=" + this.roomDateRent + ", roomPaymentStatus=" + this.roomPaymentStatus + "]";
	   }
	}
